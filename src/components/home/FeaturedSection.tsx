    ...
    <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: idx * 0.1, duration: 0.7 }}
      ...
      <div className="p-6">
        ...
        <div className="flex justify-center mt-2">
          <Link href={`/p/${b.slug}`}
            className="relative overflow-hidden inline-flex items-center justify-center gap-2 px-8 py-3 rounded-full text-[11px] font-bold tracking-[0.25em] uppercase text-white group/btn transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0"
