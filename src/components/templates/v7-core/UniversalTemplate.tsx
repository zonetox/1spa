...
export function UniversalTemplate({ 
  ...
  // Custom Inline Styles for Keyframes
  const injectStyles = `
    ...
    .btn-shine-effect:hover::after {
      ...
      animation: gold-shine 0.8s forwards;
    }
    .text-royal-shadow {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white text-[#2F2F2F] font-sans selection:bg-[#D4AF37]/20 antialiased w-full overflow-x-hidden">
        ...
        >
          <div className="container mx-auto px-6 flex justify-between items-center">
            ...
            <div className="flex items-center gap-4 cursor-pointer">
              {brandLogo ? (
                <img src={brandLogo} alt={brandName} className="h-10 md:h-12 w-auto object-contain transition-all drop-shadow-sm" />
              ) : (
          ...
          >
            {(hero_section.hero_slides?.length ? hero_section.hero_slides : [
              ...
              <SwiperSlide key={i} className="w-full h-full relative">
                ...
                >
                  <img src={slide} alt="Slide" className="w-full h-full object-cover brightness-100" />
                </motion.div>
              </SwiperSlide>
            ))}
          </Swiper>
              ...
              {services_menu.map((svc, idx) => (
                ...
                >
                  ...
                  <div className="aspect-[4/3] w-full overflow-hidden relative bg-white border-b border-gray-50">
                    <img 
                      src={svc.img || "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&q=80"} 
                      alt={svc.name} 
                ...
                >
                  <div className="relative w-64 h-64 mx-auto mb-8">
                    ...
                    <div className="w-full h-full rounded-full overflow-hidden border-4 border-white shadow-xl ring-1 ring-black/[0.03]">
                      <img 
                        src={member.img || "https://i.imgur.com/oIeQ21A.png"} 
                        alt={member.name} 
            ...
            <div className="container mx-auto px-6">
              ...
              <div className="columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
                {gallery.map((g: any, i: number) => (
                  ...
                  >
                    <img src={g.url || g.img} alt={g.caption || "Gallery"} className="w-full h-auto object-cover transition-transform duration-[1.2s] group-hover:scale-105" />
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 pb-20">
              ...
              <div className="lg:col-span-4">
                <div className="mb-8">
                  {brandLogo ? (
                    <img src={brandLogo} alt={brandName} className="h-12 w-auto object-contain mb-6 grayscale hover:grayscale-0 transition-all" />
                  ) : (
